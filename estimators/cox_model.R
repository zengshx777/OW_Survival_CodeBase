...
cox.q.model.fit <-
  function(Y,
    ...
    # truncate: (float) time point for evaluation (SPCE, RACE)
    # ipw.weighted (bool): whether we use IPW weights in fitting the model
    # boot.time: number of bootstrap times when calculating the variance
