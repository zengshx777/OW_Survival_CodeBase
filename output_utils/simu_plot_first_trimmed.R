...
if(good_overlap<=2){
  ylim.range = range(sub.data$OW.BIAS.SPCE1,sub.data$IPW.BIAS.SPCE1,sub.data$COX.Q.BIAS.SPCE1,
...
lines(sub.data$sample,sub.data$IPW.BIAS.SPCE1,col="blue",type='o',lwd=2,pch=14)
...
if(good_overlap<=2){
  ylim.range = range(sub.data$OW.BIAS.RACE1,sub.data$IPW.BIAS.RACE1,sub.data$COX.Q.BIAS.RACE1,
...
lines(sub.data$sample,sub.data$IPW.BIAS.RACE1,col="blue",type='o',lwd=2,pch=14)
...
lines(sub.data$sample,sub.data$IPW.BIAS.ASCE1,col="blue",type='o',lwd=2,pch=14)
...
plot(sub.data$sample,sub.data$OW.RMSE.SPCE1,type='o',
     col="red",ylim = range(sub.data$OW.RMSE.SPCE1,sub.data$IPW.RMSE.SPCE1,sub.data$COX.Q.RMSE.SPCE1,
...
plot(sub.data$sample,sub.data$OW.RMSE.RACE1,type='o',
     col="red",ylim = range(sub.data$OW.RMSE.RACE1,sub.data$IPW.RMSE.RACE1,sub.data$COX.Q.RMSE.RACE1,
...
lines(sub.data$sample,sub.data$IPW.RMSE.RACE1,col="blue",type='o',lwd=2,pch=14)
...
lines(sub.data$sample,sub.data$IPW.RMSE.ASCE1,col="blue",type='o',lwd=2,pch=14)
