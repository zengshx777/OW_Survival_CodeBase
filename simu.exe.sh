...
R CMD BATCH --vanilla '--args multi.arm=F prop.hazard=T good_overlap=1 sample_size=350' simu_main.R R7.out &
R CMD BATCH --vanilla '--args multi.arm=F prop.hazard=T good_overlap=2 sample_size=350' simu_main.R R8.out &
R CMD BATCH --vanilla '--args multi.arm=F prop.hazard=T good_overlap=3 sample_size=350' simu_main.R R9.out &
R CMD BATCH --vanilla '--args multi.arm=F prop.hazard=T good_overlap=1 sample_size=350' simu_main.R R10.out &
